...
class AccountFixFutureService():
    ...
    def get_account_okex(self):
        ...
        res = okcoinFuture.future_userinfo_4fix()
        print(res)
        result = res["result"]
        ...
        for cur in cur_keys:
            ...
            okex_balance_future.account_rights = float(cur_info['rights'])
            okex_balance_future.keep_deposit = float(cur_info['balance'])
            '''
