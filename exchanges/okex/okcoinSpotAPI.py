...
from talang.exchanges.okex.httpMD5Util import buildMySign, httpGet, httpPost
import talang.exchanges.okex.helper as okex_helper 
...
class OKCoinSpot:
    ...
    def getMinimumOrderQty(self, symbol):
        if symbol == okex_helper.COIN_TYPE_BTC_CNY:
            return 0.01 * 1
        else:
            return 0.1 * 1
