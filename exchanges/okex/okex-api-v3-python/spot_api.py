...
class SpotAPI(Client):
    ...
    def revoke_order(self, oid):
        return self._request_without_params(DELETE, SPOT_REVOKE_ORDER + str(oid))
    ...
    # query orders list
    def get_orders_list(self, status, product_id, before, after, limit):
    ...
    # query depth
    def get_depth(self, product_id, size, depth):
