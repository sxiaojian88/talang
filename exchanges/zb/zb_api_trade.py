...
class zb_api_trade(request_call):
    ...
    def __init__(self):
        ...
        self.access_key = talang_config.ZB["USD_1"]["ACCESS_KEY"]
        self.access_secret = talang_config.ZB["USD_1"]["SECRET_KEY"]
        self.host = 'https://trade.zb.com/api'#talang_config.ZB["USD_1"]["SERVICE_API"]
        #self.access_key=talang_config_data.config_data.ac_k_zb #你的key
        #self.access_secret=talang_config_data.config_data.ac_s_zb#你的secret
