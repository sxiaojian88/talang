...
import talang.exchanges.huobipro.HuobiUtil  as hbu
...
def get_kline(symbol, period, long_polling=None):
    ...
    url = hbu.MARKET_URL + '/market/kline'
    return hbu.http_get_request(url, params)
...
def get_depth(symbol, type, long_polling=None):
    ...
    if long_polling:
        params['long-polling'] = long_polling
    url = hbu.MARKET_URL + '/market/depth'
    return hbu.http_get_request(url, params)
...
def get_trade(symbol, long_polling=None):
    ...
    if long_polling:
        params['long-polling'] = long_polling
    url = hbu.MARKET_URL + '/market/trade'
    return hbu.http_get_request(url, params)
...
def get_detail(symbol, long_polling=None):
    ...
    if long_polling:
        params['long-polling'] = long_polling
    url = hbu.MARKET_URL + '/market/detail'
    return hbu.http_get_request(url, params)
...
def get_symbols():
    ...
    :return:
    """
    url = hbu.MARKET_URL + '/v1/common/symbols'
    params = {}
    return hbu.http_get_request(url,params)
