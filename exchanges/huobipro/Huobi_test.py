...
#from talang.exchanges.huobipro.HuobiUtil import *
import talang.exchanges.huobipro.HuobiService as HuobiServices

if __name__ == '__main__':
    # print("获取1分钟线")
    # print(HuobiServices.get_kline('ethcny', '1min'))
    print("获取合并深度为1的盘口")
    print(HuobiServices.get_depth('eosusdt', 'step5'))
    ...
    #print("获取账户")
    #print(HuobiServices.get_accounts())
    #print("获取当前账户资产")
