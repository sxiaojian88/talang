...
ACCESS_KEY = talang_config.HP["USD_1"]["ACCESS_KEY"]
SECRET_KEY = talang_config.HP["USD_1"]["SECRET_KEY"]
#MARKET_URL = TRADE_URL  = talang_config.HP["USD_1"]["SERVICE_API"]

# 此处填写APIKEY
#ACCESS_KEY = talang_config_data.config_data.ac_k_hp
#SECRET_KEY = talang_config_data.config_data.ac_s_hp
# API 请求地址
