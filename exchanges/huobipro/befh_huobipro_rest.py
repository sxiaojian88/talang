...
class ExchGwApiHuoBiProTalang(RESTfulApiSocket):
    """
    ...
    def get_order_book_link(cls, instmt):
        ...
        return "https://api.huobi.pro/market/depth?symbol=%s&type=step2" % instmt.get_instmt_code()
...
class ExchGwHuoBiProTalang(ExchangeGateway):
    """
    Exchange gateway HuoBiProTalang
    """
    ...
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwApiHuoBiProTalang(), db_clients)
...
if __name__ == '__main__':
    Logger.init_log()
    exchange_name = 'HuoBiProTalang'
    instmt_name = 'BTCETH'
    instmt_code = 'BTCETH'
    instmt = Instrument(exchange_name, instmt_name, instmt_code)
    db_client = SqlClientTemplate()
    exch = ExchGwHuoBiProTalang([db_client])
    instmt.set_l2_depth(L2Depth(5))
    instmt.set_prev_l2_depth(L2Depth(5))
    instmt.set_recovered(False)
